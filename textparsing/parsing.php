...
<body>
    <?php
        // tampil output
        if ($outputValid) { 
            echo "<p style='font-family: Poppins, sans-serif; text-align:center; font-size:15px;color:#5aa469;'> <b class= teks> $teks </b> </p>";?>
            <div class=" table table-responsive" id="tbFix">
                <table class="table table-bordered text-center" style="font-family: Poppins, sans-serif; text-align:center; font-size:15px;color:#5aa469; margin:auto;border: 1px solid #999;">
            ...
            <div class="validasi">
                <h5 style="font-family: Poppins, sans-serif; text-align:center; font-size:20px;color:#5aa469;">Status Validasi: Valid</h5>
                <?php 
                }else{ ?>
                    <h5 style="font-family: Poppins, sans-serif; text-align:center; font-size:20px; color:#5aa469">Status Validasi: Tidak Valid </h5>
                    <?php
                }?>
            </div>
</body>
